...
export default function TeacherGroups({teacherId}) {
    ...
    const [data, setData] = useState<Group>({price:null, name:'', title:'', description:'' })
    ...
    const handleGroup = async(e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault()
        try {
            const newGroup = await axios.post('/api/group', {params: {id: teacherId, price: data.price, title: data.title, description: data.description, name:data.name}})
    ...
    const updateGroup = async(e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault()
        try {
            const updatedGroup = await axios.patch(`/api/group/${updateId}`, {params: {id: teacherId, price: data.price, title: data.title, description: data.description, name: data.name}})
